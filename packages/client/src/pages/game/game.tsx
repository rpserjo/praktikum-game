...
/* eslint-disable */
// import React, { FC, MouseEventHandler, useRef, useEffect } from 'react';
...
//  Необходимо заменить на использование глобального состояния, когда начнем его использовать.zx
enum Move {
    user = 'user',
    enemy = 'enemy',
}
    ...
    useEffect(() => {
        if (ref.current) {
            ...
            [...Array(2).keys()].forEach(
                i =>
                    // eslint-disable-next-line
                    fillTextWithSpacing(ctx!, textH, 257 + 400 * i, 63, 6.6)
                // eslint-disable-next-line
            );
